...
class TestACTChannels(unittest.TestCase):
    def test_lazy_initialization(self):
        """Test that when setting to a buffer, if the accumulator was not initialized,
        it is setup with zeros of the correct shape"""
...
class TestACTChannelsErrors(unittest.TestCase):
    ...
    def test_illegal_access(self):
        ...
        with self.assertRaises(RuntimeError):
            instance["test"] # pylint: disable=pointless-statement
